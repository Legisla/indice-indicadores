...
class Legislatura:
    ...
    def _to_dict(self):
        for parlamentar in self.parlamentares:
            parlamentar_data = {"Deputado": parlamentar.nome, "external_id" : parlamentar.pid, "situacao": parlamentar.dados['ultimoStatus']['situacao'], "time_in_office": int(parlamentar.tempo['Exercício'])}
